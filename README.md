...
-   **Smart Search**: Real-time menu search with suggestions.
-   **Premium Design**: Dark mode aesthetic with gold and red accents for a luxury feel.
-   **Fully Responsive**: Optimised for mobile, tablet, and desktop viewing.
-   **Smooth Animations**: Fade-in-up transitions and interactive hover effects.

## 🛠️ Technologies Used

-   **HTML5**: Semantic structure.
-   **CSS3**: Custom styles, animations, and responsive layout (Flexbox/Grid).
-   **JavaScript (ES6+)**: Cart logic, search functionality, and UI interactions.
...
---
© 2025 Premium Bites. All Rights Reserved.
